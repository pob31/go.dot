...
| 1 | Launcher clip → multichannel bus routing | **PASS** — mono direct outs and stereo buses both exact to 72 output channels | [spike01-bus-routing.md](spike01-bus-routing.md) |
