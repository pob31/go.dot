...
DETERMINISTIC_SPIKES="spike04_graph_stability spike02_launch_offset spike01_bus_routing spike03_join_quality spike05_param_50hz spike06_rack_latency_pdc"
